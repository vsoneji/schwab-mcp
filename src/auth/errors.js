...
exports.AuthErrors = {
    MissingClientId: /** @class */ (function (_super) {
        ...
        function MissingClientId(cause) {
            return _super.call(this, 'MissingClientId', 400, 'Invalid request: clientId is missing', cause) || this;
        }
    ...
    MissingState: /** @class */ (function (_super) {
        ...
        function MissingState(cause) {
            return _super.call(this, 'MissingState', 400, 'Invalid request: state.oauthReqInfo is missing', cause) || this;
        }
        return MissingState;
    }(AuthError)),
    MissingParameters: /** @class */ (function (_super) {
        ...
        function MissingParameters(cause) {
            return _super.call(this, 'MissingParameters', 400, 'Missing required parameters', cause) || this;
        }
    ...
    InvalidState: /** @class */ (function (_super) {
        ...
        function InvalidState(cause) {
            return _super.call(this, 'InvalidState', 400, 'Invalid state: clientId is missing', cause) || this;
        }
        return InvalidState;
    }(AuthError)),
    CookieDecode: /** @class */ (function (_super) {
        ...
        function CookieDecode(cause) {
            return _super.call(this, 'CookieDecode', 400, 'Could not decode state', cause) || this;
        }
        return CookieDecode;
    }(AuthError)),
    InvalidCookieFormat: /** @class */ (function (_super) {
        ...
        function InvalidCookieFormat(cause) {
            return _super.call(this, 'InvalidCookieFormat', 400, 'Invalid cookie format received', cause) || this;
        }
    ...
    InvalidRequestMethod: /** @class */ (function (_super) {
        ...
        function InvalidRequestMethod(cause) {
            return _super.call(this, 'InvalidRequestMethod', 400, 'Invalid request method. Expected POST.', cause) || this;
        }
    ...
    MissingFormState: /** @class */ (function (_super) {
        ...
        function MissingFormState(cause) {
            return _super.call(this, 'MissingFormState', 400, "Missing or invalid 'state' in form data.", cause) || this;
        }
    ...
    ClientIdExtraction: /** @class */ (function (_super) {
        ...
        function ClientIdExtraction(cause) {
            return _super.call(this, 'ClientIdExtraction', 400, 'Could not extract clientId from state object.', cause) || this;
        }
    ...
    CookieSignature: /** @class */ (function (_super) {
        ...
        function CookieSignature(cause) {
            return _super.call(this, 'CookieSignature', 401, 'Cookie signature verification failed', cause) || this;
        }
    ...
    AuthRequest: /** @class */ (function (_super) {
        ...
        function AuthRequest(cause) {
            return _super.call(this, 'AuthRequest', 500, 'Error processing authorization request', cause) || this;
        }
        return AuthRequest;
    }(AuthError)),
    AuthApproval: /** @class */ (function (_super) {
        ...
        function AuthApproval(cause) {
            return _super.call(this, 'AuthApproval', 500, 'Error processing approval', cause) || this;
        }
        return AuthApproval;
    }(AuthError)),
    AuthCallback: /** @class */ (function (_super) {
        ...
        function AuthCallback(cause) {
            return _super.call(this, 'AuthCallback', 500, 'Authorization failed during callback processing', cause) || this;
        }
        return AuthCallback;
    }(AuthError)),
    AuthUrl: /** @class */ (function (_super) {
        ...
        function AuthUrl(cause) {
            return _super.call(this, 'AuthUrl', 500, 'Error creating authorization URL', cause) || this;
        }
        return AuthUrl;
    }(AuthError)),
    NoUserId: /** @class */ (function (_super) {
        ...
        function NoUserId(cause) {
            return _super.call(this, 'NoUserId', 500, 'Failed to retrieve user information after Schwab auth', cause) || this;
        }
        return NoUserId;
    }(AuthError)),
    TokenExchange: /** @class */ (function (_super) {
        ...
        function TokenExchange(cause) {
            return _super.call(this, 'TokenExchange', 500, 'Failed to exchange Schwab authorization code for tokens', cause) || this;
        }
    ...
    ApiResponse: /** @class */ (function (_super) {
        ...
        function ApiResponse(cause) {
            return _super.call(this, 'ApiResponse', 500, 'Schwab API request failed during authorization flow', cause) || this;
        }
        return ApiResponse;
    }(AuthError)),
    CookieSecretMissing: /** @class */ (function (_super) {
        ...
        function CookieSecretMissing(cause) {
            return _super.call(this, 'CookieSecretMissing', 500, 'COOKIE_SECRET is not defined. A secret key is required for signing cookies.', cause) || this;
        }
...
function formatAuthError(error, details) {
    ...
    if (details) {
        var stack = details.stack, rest = __rest(details, ["stack"]);
        filtered = rest;
    }
    return __assign({ message: error.message, status: error.status }, (filtered && { details: filtered }));
}
function createJsonErrorResponse(error, requestId, additionalDetails) {
    return __assign(__assign({ code: error.kind, message: error.message }, (requestId && { requestId: requestId })), (additionalDetails && { details: additionalDetails }));
}
