 ...
 */
app.get('/authorize', function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var config, oauthReqInfo, clientId, error, errorInfo, jsonResponse, clientInfo, serverInfo, error_1, authError, errorInfo, jsonResponse;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, cookies_1.clientIdAlreadyApproved)(c.req.raw, oauthReqInfo.clientId, config.COOKIE_ENCRYPTION_KEY)];
            case 2:
                // If client ID is already approved, redirect directly to Schwab
                if (_a.sent()) {
                    return [2 /*return*/, (0, client_1.redirectToSchwab)(c, config, oauthReqInfo)];
                }
            ...
            case 3:
                ...
                serverInfo = {
                    ...
                    logo: config_2.APPROVAL_CONFIG.SHOW_LOGO ? config_2.APPROVAL_CONFIG.LOGO_URL : undefined,
                };
                return [2 /*return*/, (0, approvalDialog_1.renderApprovalDialog)(c.req.raw, {
                        client: clientInfo,
                        server: serverInfo,
            ...
            case 4:
                ...
                oauthLogger.error(errorInfo.message, { error: (0, schwab_api_1.sanitizeError)(error_1) });
 ...
 */
app.post('/authorize', function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var config, _a, state, headers, error, errorInfo, jsonResponse, authRequestForSchwab, error, errorInfo, jsonResponse, error_2, authError, errorInfo, jsonResponse;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                config = (0, config_1.getConfig)(c.env);
                return [4 /*yield*/, (0, cookies_1.parseRedirectApproval)(c.req.raw, config)];
            case 1:
                ...
                if (!(authRequestForSchwab === null || authRequestForSchwab === void 0 ? void 0 : authRequestForSchwab.clientId) || !(authRequestForSchwab === null || authRequestForSchwab === void 0 ? void 0 : authRequestForSchwab.scope)) {
                    error = new errors_1.AuthErrors.InvalidState();
                    errorInfo = (0, errors_1.formatAuthError)(error, {
                        missingFields: {
                            clientId: !(authRequestForSchwab === null || authRequestForSchwab === void 0 ? void 0 : authRequestForSchwab.clientId),
                            scope: !(authRequestForSchwab === null || authRequestForSchwab === void 0 ? void 0 : authRequestForSchwab.scope),
                        },
                    });
                    oauthLogger.error(errorInfo.message);
                    jsonResponse = (0, errors_1.createJsonErrorResponse)(error, undefined, errorInfo.details);
                    return [2 /*return*/, c.json(jsonResponse, errorInfo.status)];
                }
                return [2 /*return*/, (0, client_1.redirectToSchwab)(c, config, authRequestForSchwab, headers)];
            case 2:
                error_2 = _b.sent();
                authError = new errors_1.AuthErrors.AuthApproval();
                errorInfo = (0, errors_1.formatAuthError)(authError, { error: error_2 });
                oauthLogger.error(errorInfo.message, { error: (0, schwab_api_1.sanitizeError)(error_2) });
                jsonResponse = (0, errors_1.createJsonErrorResponse)(authError);
                return [2 /*return*/, c.json(jsonResponse, errorInfo.status)];
 ...
 * authorization flow.
 */
app.get('/callback', function (c) { return __awaiter(void 0, void 0, void 0, function () {
    var config, stateParam, code, error, errorInfo, jsonResponse, decodedStateAsAuthRequest, error, errorInfo, jsonResponse, clientIdFromState_1, error, errorInfo, jsonResponse, redirectUri, kvToken_1, getInitialTokenIds_1, saveToken, loadToken, auth, exchangeError_1, client, userPreferences, preferencesError_1, userIdFromSchwab, error, errorInfo, jsonResponse, currentTokenData, migrationError_1, redirectTo, error_3, isSchwabAuthError, isSchwabApiErrorInstance, mcpError, detailMessage, httpStatus, requestId, schwabAuthErr, errorMapping, schwabApiErr, errorInfo, jsonResponse;
    var _a, _b;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, stateUtils_1.decodeAndVerifyState)(config, stateParam)];
            case 1:
                ...
                clientIdFromState_1 = (0, stateUtils_1.extractClientIdFromState)(decodedStateAsAuthRequest);
                // Validate required AuthRequest fields directly on `decodedStateAsAuthRequest`
                if (!(decodedStateAsAuthRequest === null || decodedStateAsAuthRequest === void 0 ? void 0 : decodedStateAsAuthRequest.clientId) || // Should be redundant due to extractClientIdFromState
                    !(decodedStateAsAuthRequest === null || decodedStateAsAuthRequest === void 0 ? void 0 : decodedStateAsAuthRequest.redirectUri) ||
                    !(decodedStateAsAuthRequest === null || decodedStateAsAuthRequest === void 0 ? void 0 : decodedStateAsAuthRequest.scope)) {
                    error = new errors_1.AuthErrors.InvalidState();
                    errorInfo = (0, errors_1.formatAuthError)(error, {
                ...
                getInitialTokenIds_1 = function () { return ({ clientId: clientIdFromState_1 }); };
                saveToken = function (tokenData) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, kvToken_1.save(getInitialTokenIds_1(), tokenData)];
                            case 1:
                                _a.sent();
                                return [2 /*return*/];
                        }
                ...
                loadToken = function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, kvToken_1.load(getInitialTokenIds_1())];
                            case 1: return [2 /*return*/, _a.sent()];
                        }
                    });
                }); };
                auth = (0, client_1.initializeSchwabAuthClient)(config, redirectUri, loadToken, saveToken);
            ...
            case 4:
                ...
                oauthLogger.error('Token exchange failed', {
                    ...
                    message: exchangeError_1 instanceof Error
            ...
            case 8:
                ...
                oauthLogger.error('Failed to fetch user preferences', {
                    ...
                    message: preferencesError_1 instanceof Error
                        ? preferencesError_1.message
                        : String(preferencesError_1),
                });
                throw new errors_1.AuthErrors.NoUserId();
            case 9:
                userIdFromSchwab = (_b = (_a = userPreferences === null || userPreferences === void 0 ? void 0 : userPreferences.streamerInfo) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.schwabClientCorrelId;
                if (!userIdFromSchwab) {
            ...
            case 11:
                ...
                return [4 /*yield*/, kvToken_1.save({ schwabUserId: userIdFromSchwab }, currentTokenData)];
            case 12:
                // Save under schwabUserId key
                _c.sent();
                oauthLogger.info('Token migrated to schwabUserId key', {
                    fromKeyPrefix: (0, schwab_api_1.sanitizeKeyForLog)(kvToken_1.kvKey({ clientId: clientIdFromState_1 })),
                    toKeyPrefix: (0, schwab_api_1.sanitizeKeyForLog)(kvToken_1.kvKey({ schwabUserId: userIdFromSchwab })),
                });
                _c.label = 13;
            ...
            case 14:
                ...
                oauthLogger.warn('Token migration failed, continuing with authorization', {
                    error: migrationError_1 instanceof Error
                        ? migrationError_1.message
                        : String(migrationError_1),
                });
                return [3 /*break*/, 15];
            case 15: return [4 /*yield*/, c.env.OAUTH_PROVIDER.completeAuthorization({
            ...
            case 17:
                ...
                isSchwabApiErrorInstance = error_3 instanceof schwab_api_1.SchwabApiError;
                mcpError = new errors_1.AuthErrors.AuthCallback() // Default MCP error for this handler
                ;
                detailMessage = error_3 instanceof Error ? error_3.message : String(error_3);
                httpStatus = 500 // Default HTTP status
                ;
                requestId = void 0;
                if (isSchwabAuthError) {
                    schwabAuthErr = error_3;
                    errorMapping = (0, errorMapping_1.mapSchwabError)(schwabAuthErr.code, schwabAuthErr.message, schwabAuthErr.status);
                    ...
                    detailMessage = "API request failed during authorization: ".concat(schwabApiErr.message);
                ...
                oauthLogger.error("Auth callback failed: ".concat(errorInfo.message), __assign({ errorType: mcpError.constructor.name }, (requestId && { requestId: requestId })));
                jsonResponse = (0, errors_1.createJsonErrorResponse)(mcpError, requestId, {});
                return [2 /*return*/, c.json(jsonResponse, errorInfo.status)];
