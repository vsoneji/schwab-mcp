...
function initializeSchwabAuthClient(config, redirectUri, load, save) {
	...
	var _a = (0, tokenPersistence_1.mapTokenPersistence)(load, save),
		mappedLoad = _a.load,
		mappedSave = _a.save
...
function redirectToSchwab(c_1, config_1, oauthReqInfo_1) {
	return __awaiter(
		...
		arguments,
		void 0,
		function (c, config, oauthReqInfo, headers) {
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					...
					case 2:
						error_1 = _a.sent()
						authError = new errors_1.AuthErrors.AuthUrl(
						...
						return [
							2 /*return*/,
							new Response(errorInfo.message, { status: errorInfo.status }),
						]
					case 3:
						return [2 /*return*/]
				}
