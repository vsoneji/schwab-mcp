...
function mapSchwabError(code, originalMessage, schwabStatus) {
    ...
    var mockError = {
        ...
        status: schwabStatus,
        isRetryable: function () { return false; },
    };
    var mapping = errorMapper.map(mockError);
    // Map the SDK error code to MCP error class
    var mcpErrorMap = (_a = {},
        _a[schwab_api_1.AuthErrorCode.INVALID_CODE] = function () { return new errors_1.AuthErrors.TokenExchange(); },
        ...
        _a[schwab_api_1.AuthErrorCode.UNAUTHORIZED] = function () { return new errors_1.AuthErrors.TokenExchange(); },
        _a[schwab_api_1.AuthErrorCode.TOKEN_PERSISTENCE_LOAD_FAILED] = function () {
            return new errors_1.AuthErrors.AuthCallback();
        },
        _a[schwab_api_1.AuthErrorCode.TOKEN_PERSISTENCE_SAVE_FAILED] = function () {
            return new errors_1.AuthErrors.AuthCallback();
        },
        ...
        _a[schwab_api_1.AuthErrorCode.REFRESH_NEEDED] = function () { return new errors_1.AuthErrors.ApiResponse(); },
        _a[schwab_api_1.AuthErrorCode.NETWORK] = function () { return new errors_1.AuthErrors.ApiResponse(); },
        _a[schwab_api_1.AuthErrorCode.UNKNOWN] = function () { return new errors_1.AuthErrors.AuthCallback(); },
        _a);
    var mcpErrorFactory = mcpErrorMap[code] || (function () { return new errors_1.AuthErrors.AuthCallback(); });
    return {
