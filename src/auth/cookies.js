			...
			switch (_a.label) {
				...
				case 2:
					...
					try {
						...
						return [
							2 /*return*/,
							schemas_1.ApprovedClientsSchema.parse(approvedClients),
						]
					} catch (e) {
...
function clientIdAlreadyApproved(request, clientId, cookieSecret) {
	return __awaiter(this, void 0, void 0, function () {
		...
		return __generator(this, function (_b) {
			switch (_b.label) {
				case 0:
					if (!clientId) return [2 /*return*/, false]
				...
				case 1:
					...
					return [
						2 /*return*/,
						(_a =
							approvedClients === null || approvedClients === void 0
								? void 0
								: approvedClients.includes(clientId)) !== null && _a !== void 0
							? _a
							: false,
					]
			}
			...
			switch (_c.label) {
				...
				case 2:
					...
					try {
						...
						cookieLogger.warn(
							'Standard base64 decode failed, trying OAuth decoder',
						)
				...
				case 3:
					...
					if (
						e_1 instanceof errors_1.AuthErrors.InvalidState ||
						e_1 instanceof errors_1.AuthErrors.MissingFormState ||
						e_1 instanceof errors_1.AuthErrors.ClientIdExtraction
					) {
						throw e_1
					}
					throw new errors_1.AuthErrors.CookieDecode(
						e_1 instanceof Error ? e_1 : undefined,
					)
				case 4:
					cookieHeader = request.headers.get('Cookie')
					return [4 /*yield*/, parseApprovalCookie(cookieHeader, cookieSecret)]
				case 5:
					...
					updatedApprovedClients = Array.from(
						new Set(
							__spreadArray(
								__spreadArray([], existingApprovedClients, true),
								[clientId],
								false,
							),
						),
					...
					return [
						4 /*yield*/,
						setApprovalCookie(updatedApprovedClients, cookieSecret),
					]
				case 6:
					...
					return [
						2 /*return*/,
						{
							...
							headers:
								((_a = {}),
								(_a[constants_1.HTTP_HEADERS.SET_COOKIE] = cookieHeaderValue),
								_a),
						},
					]
			}
