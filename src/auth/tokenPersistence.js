...
exports.mapTokenPersistence = mapTokenPersistence;
/**
 ...
 */
function mapTokenPersistence(load, save) {
    var _this = this;
    var mappedLoad = load
        ...
        : undefined;
    var mappedSave = save
        ? function (d) { return __awaiter(_this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/, save(d)];
        }); }); }
        : undefined;
    return {
        load: mappedLoad,
