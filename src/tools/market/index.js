...
exports.toolSpecs = [
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, c.marketData.quotes.getQuotes({
                        queryParams: {
                            symbols: p.symbols,
                            fields: p.fields,
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, c.marketData.quotes.getQuoteBySymbolId({
    ...
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.marketData.instruments.getInstrumentByCusip({
