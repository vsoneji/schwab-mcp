...
exports.toolSpecs = [
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, c.trader.accounts.getAccounts({
                                queryParams: { fields: p === null || p === void 0 ? void 0 : p.fields },
                            })];
                    case 1:
                        accounts = _a.sent();
                        accountSummaries = accounts.map(function (acc) { return (__assign({}, acc.securitiesAccount)); });
                        return [4 /*yield*/, (0, schwab_api_1.buildAccountDisplayMap)(c)];
                    case 2:
                        displayMap = _a.sent();
                        return [2 /*return*/, (0, schwab_api_1.scrubAccountIdentifiers)(accountSummaries, displayMap)];
                }
            });
        }); },
    }),
    ...
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.trader.accounts.getAccountByNumber({
                    ...
                    case 2:
                        displayMap = _a.sent();
                        return [2 /*return*/, (0, schwab_api_1.scrubAccountIdentifiers)(account, displayMap)];
                }
            });
        }); },
    }),
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, c.trader.orders.getOrders({ queryParams: p })];
                    case 1:
                        orders = _a.sent();
                        return [4 /*yield*/, (0, schwab_api_1.buildAccountDisplayMap)(c)];
                    case 2:
                        displayMap = _a.sent();
                        return [2 /*return*/, (0, schwab_api_1.scrubAccountIdentifiers)(orders, displayMap)];
                }
            });
        }); },
    }),
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.trader.orders.getOrdersByAccount({
                            pathParams: { accountNumber: p.accountNumber },
                            queryParams: p,
                        })];
                    case 1:
    ...
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.trader.orders.placeOrderForAccount({
                            pathParams: { accountNumber: p.accountNumber },
                            body: p,
                        })];
                    case 1:
                    ...
                    case 2:
                        displayMap = _a.sent();
                        return [2 /*return*/, (0, schwab_api_1.scrubAccountIdentifiers)(order, displayMap)];
                }
            });
        }); },
    }),
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.trader.orders.getOrderByOrderId({
    ...
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.trader.orders.cancelOrder({
                            pathParams: { accountNumber: p.accountNumber, orderId: p.orderId },
                        })];
                    case 1:
                        order = _a.sent();
    ...
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, c.trader.orders.replaceOrder({
                            pathParams: { accountNumber: p.accountNumber, orderId: p.orderId },
                            body: p,
                        })];
                    case 1:
    ...
    (0, types_1.createToolSpec)({
        ...
        call: function (c, p) { return __awaiter(void 0, void 0, void 0, function () {
            var accounts, transactions, _i, accounts_1, account, accountTransactions, displayMap;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, c.trader.transactions.getTransactions({
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [4 /*yield*/, (0, schwab_api_1.buildAccountDisplayMap)(c)];
                    case 6:
                        displayMap = _a.sent();
                        return [2 /*return*/, (0, schwab_api_1.scrubAccountIdentifiers)(transactions, displayMap)];
                }
            });
        }); },
    }),
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        log_1.logger.info('[getUserPreference] User preference fetched', {
                            hasAccounts: ((_a = userPreference.accounts) === null || _a === void 0 ? void 0 : _a.length) > 0,
                            accountCount: ((_b = userPreference.accounts) === null || _b === void 0 ? void 0 : _b.length) || 0,
                            hasStreamerInfo: ((_c = userPreference.streamerInfo) === null || _c === void 0 ? void 0 : _c.length) > 0,
                        });
                        return [4 /*yield*/, (0, schwab_api_1.buildAccountDisplayMap)(c)];
                    case 2:
                        displayMap = _d.sent();
                        return [2 /*return*/, (0, schwab_api_1.scrubAccountIdentifiers)(userPreference, displayMap)];
                }
            });
        }); },
    }),
