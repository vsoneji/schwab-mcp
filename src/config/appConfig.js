...
var envSchema = zod_1.z.object({
    ...
    COOKIE_ENCRYPTION_KEY: zod_1.z
        .string({
        required_error: 'COOKIE_ENCRYPTION_KEY is required for secure cookie storage',
    })
    ...
    OAUTH_KV: zod_1.z.any().refine(function (v) { return !!v; }, {
...
exports.getConfig = (function () {
    ...
    return function (env) {
        ...
        var envHash = JSON.stringify(Object.keys(env)
            .filter(function (key) { return key !== 'OAUTH_PROVIDER'; }) // Exclude circular reference
            .sort()
            .map(function (key) { return [key, env[key]]; }));
