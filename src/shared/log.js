...
var serializers = {
    ...
    req: function (req) {
        ...
        if ((_a = serialized.headers) === null || _a === void 0 ? void 0 : _a.authorization) {
            serialized.headers.authorization = '[REDACTED]';
        }
        if ((_b = serialized.headers) === null || _b === void 0 ? void 0 : _b.cookie) {
...
function buildLogger(level) {
    ...
    var baseLogger = (0, pino_1.default)(__assign(__assign({}, pinoConfig), { level: level }));
