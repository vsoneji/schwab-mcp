			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					case 0:
												...
												content: [
													{
														...
														text: ''.concat(
															constants_1.APP_SERVER_NAME,
															' is running. Use tool discovery to see all available tools.',
														),
													},
												],
											},
						...
						kvToken_1 = (0, kvTokenStore_1.makeKvTokenStore)(
						...
						;(0, secureLogger_1.logOnlyInDevelopment)(
							this.mcpLogger,
							'debug',
							'[MyMCP.init] Token identifiers',
							{
								...
								expectedKeyPrefix: (0, schwab_api_1.sanitizeKeyForLog)(
									kvToken_1.kvKey(getTokenIds_1()),
								),
							},
						)
						saveTokenForETM = function (tokenSet) {
							return __awaiter(_this, void 0, void 0, function () {
								return __generator(this, function (_a) {
									switch (_a.label) {
										case 0:
											return [
												4 /*yield*/,
												kvToken_1.save(getTokenIds_1(), tokenSet),
											]
										case 1:
											_a.sent()
											this.mcpLogger.debug('ETM: Token save to KV complete', {
												keyPrefix: (0, schwab_api_1.sanitizeKeyForLog)(
													kvToken_1.kvKey(getTokenIds_1()),
												),
											})
											return [2 /*return*/]
									...
									switch (_a.label) {
										case 0:
											...
											this.mcpLogger.debug(
												'[ETM Load] Attempting to load token',
												{
													hasSchwabUserId: !!tokenIds.schwabUserId,
													hasClientId: !!tokenIds.clientId,
													expectedKeyPrefix: (0,
													schwab_api_1.sanitizeKeyForLog)(
														kvToken_1.kvKey(tokenIds),
													),
												},
											)
						...
						if (!this.tokenManager) {
							this.tokenManager = (0, auth_1.initializeSchwabAuthClient)(
						...
						this.mcpLogger.debug(
							'[MyMCP.init] STEP 5B: Proactive ETM initialization complete. Success: '.concat(
								etmInitSuccess,
							),
						)
					...
					case 1:
						_a.sent()
						this.mcpLogger.debug(
							'[MyMCP.init] STEP 5C: Token migration completed',
						)
						_a.label = 2
					case 2:
						...
						this.mcpLogger.debug(
							'[MyMCP.init] STEP 7A: Calling registerTools...',
						)
										...
										return __generator(this, function (_a) {
											switch (_a.label) {
												...
												case 1:
													...
													return [
														2 /*return*/,
														(0, toolBuilder_1.toolSuccess)({
															data: data,
															source: spec.name,
															message: 'Successfully executed '.concat(
																spec.name,
															),
														}),
													]
												case 2:
													...
													return [
														2 /*return*/,
														(0, toolBuilder_1.toolError)(error_2, {
															source: spec.name,
														}),
													]
												case 3:
						...
						this.mcpLogger.debug(
							'[MyMCP.init] STEP 7B: registerTools completed.',
						)
						this.mcpLogger.debug(
			...
			return __generator(this, function (_a) {
				switch (_a.label) {
					...
					case 4:
						_a.trys.push([4, 6, , 7])
						this.mcpLogger.info(
							'Attempting to fetch access token as recovery test',
						)
					...
					case 6:
						...
						this.mcpLogger.warn(
							'Failed to get access token during reconnection',
							{
								error:
									tokenError_1 instanceof Error
					...
					case 8:
						initResult = _a.sent()
						this.mcpLogger.info(
							'Token manager reinitialization '.concat(
								initResult ? 'succeeded' : 'failed',
							),
						)
						if (initResult) {
							return [2 /*return*/, true]
					...
					case 12:
						...
						this.mcpLogger.error(
							'Critical error during reconnection handling',
							{
								error: message,
								stack: stack,
							},
